...
export function SpecializationsPage() {
  const specializations = [
    {
      ...
      seoText:
        "Advanced minimally invasive techniques for quicker healing, minimal scars, and shorter hospital stay. Leading expert in MICS procedures in Coimbatore.",
    },
    {
      ...
      seoText:
        "Expert in bypass and valve surgeries with high success rate and faster recovery. Specialized in complex adult cardiac procedures using advanced techniques.",
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1723031840495-57a7154b191b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwZWRpYXRyaWMlMjBoZWFydCUyMHN1cmdlcnklMjBjaGlsZHJlbiUyMGhvc3BpdGFsfGVufDF8fHx8MTc1NjcwNzg1MXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
      procedures: [
      ...
      seoText:
        "Specialized in life-saving congenital heart surgeries for children. Expertise in complex pediatric cardiac procedures with focus on gentle, child-centered care.",
    },
    {
      ...
      seoText:
        "Expert care in complex thoracic and vascular procedures using cutting-edge technology. Specialized in aortic surgeries and minimally invasive thoracic procedures.",
    },
    {
      ...
      seoText:
        "Expert in advanced aortic and complex heart procedures with precision techniques to ensure optimal outcomes. Specialized in treating life-threatening conditions involving the aorta and complex structural abnormalities of the heart.",
    },
  ];
  ...
  const patientJourneySteps = [
    ...
    },
    {
      ...
      description:
        "State-of-the-art surgical procedures with latest techniques",
      icon: HeartPulse,
      color: "from-red-500 to-red-600",
    },
    {
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl lg:text-2xl text-blue-100 leading-relaxed max-w-3xl mx-auto">
              ...
              Services in Coimbatore – Expertise in Adult, Pediatric, and{" "}
              <span className="text-white font-semibold">
                Minimally Invasive Cardiac Care
              </span>{" "}
              with world-class surgical outcomes.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-5 border-2 gap-8 w-full">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 leading-relaxed mb-12">
              ...
              <strong className="text-gray-900">Dr. G. Praveen Prabu</strong>{" "}
              provides advanced treatment in cardiovascular and thoracic
              surgery, combining precision with compassionate care. From{" "}
              <span className="text-blue-600 font-medium">
                beating-heart bypass
              </span>{" "}
              to{" "}
              <span className="text-teal-600 font-medium">
                pediatric congenital heart repairs
              </span>
              , he specializes in procedures that ensure faster recovery and
              improved quality of life for every patient.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 w-full max-w-7xl mx-auto">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-2xl text-center">
              ...
              <p className="text-gray-600 text-sm">
                Complex bypass and valve procedures
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-2xl text-center">
            <HeartPulse className="h-10 w-10 text-purple-600 mb-4 mx-auto" />
              <h4 className="text-lg font-semibold text-gray-900 mb-2">
              Aortic & Complex Heart Surgeries 
              </h4>
              <p className="text-gray-600 text-sm">Aortic repairs and advanced cardiac reconstructions</p>
            </div>

            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-2xl text-center">
            <Activity className="h-10 w-10 text-purple-600 mb-4 mx-auto" />
              <h4 className="text-lg font-semibold text-gray-900 mb-2">
              Thoracic & Vascular Surgeries
              </h4>
              <p className="text-gray-600 text-sm">Lung, chest, and vascular procedures</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Dr. Praveen offers a complete range of cardiac and thoracic
              surgical procedures, utilizing the latest medical technologies and
          ...
          <div className="grid gap-8">
            {specializations.map((spec, index) => (
              <Card
                key={index}
                className="overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 group border-0"
              >
                <div
                ...
                >
                  ...
                  >
                    ...
                    />
                    <div
                      className={`absolute inset-0 bg-gradient-to-r ${spec.color} opacity-20`}
                    ></div>
                    <div className="absolute top-4 left-4">
                      <div
                        className={`bg-gradient-to-br ${spec.color} w-12 h-12 rounded-xl flex items-center justify-center`}
                      >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              ...
              <strong className="text-blue-600">
                best cardiothoracic surgeons in Coimbatore
              </strong>{" "}
              for complex heart and thoracic procedures. Dr. Praveen combines
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {whyChoosePoints.map((point, index) => (
              <Card
                key={index}
                className="text-center p-8 shadow-lg hover:shadow-xl transition-all duration-300 group border-0"
              >
          ...
          <div className="text-center mt-12">
            <p className="text-lg text-blue-600 font-medium max-w-2xl mx-auto">
              "Trusted by patients across Tamil Nadu for life-saving cardiac
              procedures with exceptional surgical outcomes and personalized
              care."
            </p>
          </div>
        </div>
      ...
      <section className="py-24 bg-gradient-to-br from-blue-50 via-white to-teal-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Every patient receives personalized attention throughout their
              cardiac care journey, from initial consultation to complete
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {patientJourneySteps.map((step, index) => (
                <Card
                  key={index}
                  className="relative p-8 text-center shadow-lg hover:shadow-xl transition-all duration-300 group border-0"
                >
                  <CardContent className="space-y-4">
                    <div className="relative">
                      <div
                        className={`bg-gradient-to-br ${step.color} w-16 h-16 rounded-2xl flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-200`}
                      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl text-blue-100 leading-relaxed mb-10 max-w-3xl mx-auto">
              Don't wait when it comes to your cardiac health. Book your
              consultation with
              <span className="text-white font-semibold">
                {" "}
                Dr. G. Praveen Prabu
              </span>{" "}
              today and take the first step towards expert cardiac care with
              compassionate treatment and proven surgical excellence.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-16">
              <div className="text-center">
                ...
                <p className="text-blue-100 text-sm">
                  Available for urgent cardiac cases
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-blue-100 text-sm">
                  Most major insurance plans supported
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-blue-100 text-sm">
                  Complete cardiac care from diagnosis to recovery
                </p>
              </div>
            </div>
          </div>
